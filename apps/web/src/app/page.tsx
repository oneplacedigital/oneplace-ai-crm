...
export default function Home() {
  return (
    <main className="min-h-screen bg-ink-500 text-white">
      <div className="mx-auto flex min-h-screen max-w-pipora flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="text-balance text-5xl font-bold leading-tight md:text-7xl">
          Pipora<span className="bg-pipora-gradient bg-clip-text text-transparent">.</span>
        </h1>
