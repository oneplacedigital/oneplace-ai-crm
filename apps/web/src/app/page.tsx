    ...
    <main className="min-h-screen bg-ink-500 text-white">
      <div className="mx-auto flex min-h-screen max-w-pipely flex-col items-center justify-center px-6 text-center">
        ...
        <h1 className="text-balance text-5xl font-bold leading-tight md:text-7xl">
          Klozent<span className="bg-klozent-gradient bg-clip-text text-transparent">.</span>
        </h1>
        <p className="mt-3 text-xl text-slate-300 md:text-2xl">
          The AI CRM that closes for you.
        </p>
        <p className="mt-6 max-w-2xl text-lg text-slate-400">
          Capture leads from your ads and forms, auto-convert them with WhatsApp + email
          follow-ups, score with AI, and move every deal down the pipeline on autopilot. Built for
          fast-growing sales teams worldwide.
        </p>
        ...
        <p className="mt-12 text-xs text-slate-500">
          v0.2 · Phase A — License keys, Super Admin, Email automation
        </p>
      </div>
    </main>
  );
